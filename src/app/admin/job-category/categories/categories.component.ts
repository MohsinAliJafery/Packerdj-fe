...
export class CategoriesComponent implements OnInit {
  ...
  constructor(private router: Router, private category_service: JobCategoryService,
  ...
  onCreate() {
    let id = "add";
    this.router.navigateByUrl('/admin/dashboard/jobcategory/' + id);
  }
  ...
  editCategory(id: any) {
    const url = `/admin/dashboard/jobcategory/edit?id=${id}`
